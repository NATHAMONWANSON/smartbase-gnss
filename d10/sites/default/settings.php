 ...
 * @endcode
 */
$settings['hash_salt'] = 'BOYoOTp0VVwJsqBGpbpDhe0bN6iRi4j8MQH73Fto1wXdYxQt24Bx4S4vSciWwy7d9EULXP4dhA';
...
$settings['config_sync_directory'] = 'sites/default/files/config_Ty4nL0CSY6kllahtqjPuytbWdLKzUDfX_L0QNmoGbtXSSOUcy-cAnGb6ZNi9PKmTxVQuXjsLyQ/sync';
/**
 * Trusted host patterns.
 *
 * @see https://www.drupal.org/docs/8/configuration/securing-your-site/trusted-host-settings-in-drupal-8
 */
$settings['trusted_host_patterns'] = [
  '^192\.168\.1\.21$',
];
// Disable all outgoing emails.
$config['system.mail']['interface']['default'] = 'Drupal\Core\Mail\NullMail';

// Disable Symfony Mailer (Drupal 10).
$config['system.mail']['mailer_dsn'] = [
  'scheme' => 'null',
];

// 1. อนุญาตให้เข้าเว็บผ่าน IP เครื่องตัวเอง และ โดเมนของอาจารย์ได้ (อนุญาตทั้งหมด)
$settings['trusted_host_patterns'] = [
  '^.*$',
];

// 2. บอก Drupal ว่าถ้าระบบของอาจารย์ส่งมาเป็น HTTPS... (ส่วนนี้ปล่อยไว้เหมือนเดิมถูกต้องแล้วครับ)
